package com.cjrequena.sample.es.core.configuration;
...
@EnableJpaRepositories(
  ...
  basePackages = {"com.cjrequena.sample.es.core.persistence.repository"}
)
public class EventStoreDataSourceConfiguration {
  ...
  public LocalContainerEntityManagerFactoryBean entityManagerFactoryEventStore(
    ...
    return builder
      ...
      .packages("com.cjrequena.sample.es.core.persistence.entity")
