...
import com.cjrequena.sample.query.handler.domain.model.vo.BookingPlacedEventDataVO;
...
/**
 * Event representing that a booking has been placed in the system.
 * <p>
 ...
 * (encapsulated in BookingPlacedEventData).
 * </p>
 * <p>
 * Event Structure:
 * <ul>
...
@Log4j2
public class BookingPlacedEvent extends Event {
  ...
  @Valid
  private final BookingPlacedEventDataVO data;
  ...
  public String getEventType() {
    return EventType.BOOKING_PLACED_EVENT.getType();
  }
  ...
  public EventEntity mapToEventEntity() {
    if (mapper == null) {
      throw new IllegalStateException(
        "BookingPlacedEventMapper not initialized. Ensure Spring context is loaded."
      );
    }
    return mapper.bookingPlacedEventToEventEntity(this);
  }
}
