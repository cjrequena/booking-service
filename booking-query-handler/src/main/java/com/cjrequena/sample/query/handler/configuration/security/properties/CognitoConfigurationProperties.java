package com.cjrequena.sample.query.handler.configuration.security.properties;
 ...
 *
 * <p>Adapted from the standalone query handler. When {@code enabled} is {@code true} and an
