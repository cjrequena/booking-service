...
@Component
@Transactional
public class PlaceBookingCommandHandler extends CommandHandler<PlaceBookingCommand> {


  @Autowired
  public PlaceBookingCommandHandler(
  ...
  public Aggregate handle(@Nonnull Command command) {
    ...
    if (!(command instanceof PlaceBookingCommand)) {
      throw new IllegalArgumentException("Expected command of type PlaceBookingCommand but received " + command.getClass().getSimpleName());
    }
  ...
  @Nonnull
  @Override
  public Class<PlaceBookingCommand> getCommandType() {
    return PlaceBookingCommand.class;
  }
