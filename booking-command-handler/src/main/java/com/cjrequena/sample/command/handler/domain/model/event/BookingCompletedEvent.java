...
import com.cjrequena.sample.command.handler.domain.model.vo.BookingCompletedEventDataVO;
...
/**
 * Event representing that a booking has been completed in the system.
 *
 * @author cjrequena
 */
@Getter
...
@Log4j2
public class BookingCompletedEvent extends Event {
  ...
  @Valid
  private final BookingCompletedEventDataVO data;

  @Nonnull
  @Override
  public String getEventType() {
    return EventType.BOOKING_COMPLETED_EVENT.getType();
  }
  ...
  public EventEntity mapToEventEntity() {
    ...
    return mapper.bookingCompletedEventToEventEntity(this);
  }
}
