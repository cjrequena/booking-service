 ...
 * It uses inheritance for persistence purposes, while the domain layer uses
 * composition with ProductMetadataVO for better flexibility.
 * </p>
 * <p>
 * Note: This persistence model uses inheritance for MongoDB polymorphic persistence,
 * which differs from the domain model's composition-based approach. This is a
 * deliberate design choice to leverage MongoDB's document model effectively.
 * </p>
 *
 * @author cjrequena
 */
