...
@DisplayName("CreateBookingCommand Tests")
class CreateBookingCommandTest {
  ...
  void shouldHaveMeaningfulToString() {
    ...
    assertTrue(toString.contains("CreateBookingCommand"));
  }

  @Test
  @DisplayName("Should create command without metadata")
  void shouldCreateCommandWithoutMetadata() {
    CreateBookingCommand command = CreateBookingCommand.builder()
      .paxes(paxes)
      .leadPaxId(leadPaxId)
      .products(products)
    ...
    assertNotNull(command);
    assertNull(command.getMetadata());
  }
}
